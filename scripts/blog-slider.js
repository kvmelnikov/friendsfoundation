class Slider {
    static ATTRIBUTE = 'blog';
    static EVENT_NAME = 'slider-start';
    static CLASS_CONTROL = 'blog__slider-control';
    static CLASS_CONTROL_HIDE = 'blog__slider-control_hidden';
    static CLASS_ITEM_ACTIVE = 'blog__card_active';
    static CLASS_INDICATOR_ACTIVE = 'blog__slider-indicator_active';
    static CLASS_CONTAINER = 'blog__container';
    static CLASS_ITEM = 'blog__card';
    static CLASS_ITEMS = 'blog__cards';
    static CLASS_PREV = 'blog__slider-control[data-slide="prev"]';
    static CLASS_NEXT = 'blog__slider-control[data-slide="next"]';
    static CLASS_INDICATOR = 'blog__slider-indicator';
    static CLASS_TRANSITION_OFF = 'blog__slider_disable-transition';
